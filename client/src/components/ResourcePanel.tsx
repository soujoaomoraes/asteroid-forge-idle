      ...
      <div className="resources-grid">
        <div className="resource-item crystals">
          ...
          <div className="resource-info">
            ...
            <div className="resource-amount">{formatNumber(gameStats.currentResources.crystals)}</div>
            <div className="resource-rate">
              {formatProduction(gameStats.production.crystals)}
            </div>
          </div>
        </div>
        ...
        <div className="resource-item energy">
          ...
          <div className="resource-info">
            ...
            <div className="resource-amount">{formatNumber(gameStats.currentResources.energy)}</div>
            <div className="resource-rate">
              {formatProduction(gameStats.production.energy)}
            </div>
          </div>
        </div>
        ...
        <div className="resource-item research">
          ...
          <div className="resource-info">
            ...
            <div className="resource-amount">{formatNumber(gameStats.currentResources.research)}</div>
            <div className="resource-rate">
              {formatProduction(gameStats.production.research)}
            </div>
          </div>
        </div>
        ...
        <div className="resource-item reputation">
          ...
          <div className="resource-info">
            ...
            <div className="resource-amount">{formatNumber(gameStats.currentResources.reputation)}</div>
            <div className="resource-rate">
              {formatProduction(gameStats.production.reputation)}
            </div>
          </div>
        </div>
      </div>
